...
DWORD WINAPI WriteToFiles(LPVOID lp)
{
	...
	ofstream create2(TEXT("Copy1.txt"));
	CopyFile(L"C:\\Users\\Dimas\Downloads\\Êðèòè÷åñêèå ñåêöèè\\CriticalSection\\CriticalSection\\Copy.txt",
		L"C:\\Users\\Dimas\\Downloads\\Êðèòè÷åñêèå ñåêöèè\\CriticalSection\\CriticalSection\\Copy2.txt", 0);
	if (create2.is_open()) {
		MessageBox(0, TEXT("Êîïèÿ 2 ñîçäàíà"), TEXT(""), MB_OK);
	}
	create2.close();
